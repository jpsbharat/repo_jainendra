...
/**
 * This program is for converting number x to number y. 
 * Following are the allowed operations: 
 *   x -> x * 2 
 *   x -> x - 1
 */
public class ConvertNumberXToY {
	...
	public static void main(String[] args) {
		StepResult sr = ConvertNumberXToY
				.getMinOperationToConvertNumberX2NumberY(3, 7);
	...
	public static StepResult getMinOperationToConvertNumberX2NumberY(int x,
			int y) {
